...
public class TestingSupport {
	public static final String HARDCODEMARKER = "";
	...
	public static String getStringForTwoDimIntArray(int[][] data) {
		if (data == null) {
			throw new IllegalArgumentException("getStringForTwoDimIntArray");
		}
